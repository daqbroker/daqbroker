...
class instruments(daqbroker_database):
    ...
    sources = relationship("instmeta", back_populates="meta", cascade="all, delete, delete-orphan", order_by="instmeta.metaid")
...
class instmeta(daqbroker_database):
    ...
    meta = relationship("instruments", back_populates="sources")
    channels = relationship("channels", back_populates="chann", cascade="all, delete, delete-orphan", order_by="channels.channelid")
    parsing = relationship("parsing", back_populates="metaParse", cascade="all, delete, delete-orphan")
...
class channels(daqbroker_database):
    ...
    units = Column(Text)
    #instid = Column(Integer, ForeignKey('instmeta.instid'))
    #instid = Column(Integer, primary_key=True)
    description = Column(Text)
    active = Column(Boolean)
    remarks = Column(Text)
...
class parsing(daqbroker_database):
    ...
    #metaid = Column(Integer, primary_key=True)
    #instid = Column(Integer, ForeignKey('instmeta.instid'),primary_key=True)
    #instid = Column(Integer, primary_key=True)
    type = Column(Integer)
